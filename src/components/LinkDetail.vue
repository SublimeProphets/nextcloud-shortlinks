...
const tabs: DetailTab[] = ['details', 'stats', 'activity', 'shares']
	...
	<section v-else class="detail-panel">
		...
		<ul class="share-list">
			<li v-for="share in shares" :key="share.id">
				<span>{{ share.type }}: {{ share.principalId }} · {{ share.purpose }} · {{ share.permission }}</span>
