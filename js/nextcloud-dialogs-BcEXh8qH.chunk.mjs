...
import { s as spawnDialog, N as NcEmptyContent, a as NcDialog, b as NcActions, c as NcActionInput, d as NcBreadcrumb, e as NcBreadcrumbs, f as NcCheckboxRadioSwitch, g as NcButton, _ as _sfc_main$f, h as NcIconSvgWrapper, i as NcSelect, j as _sfc_main$g } from "./nextcloud-ui-Dwfo27ZN.chunk.mjs";
import { g as getGettextBuilder, e as getLoggerBuilder, U as Toastify, V as basename, W as PQueue, X as FileType, Y as generateUrl, v as emit, Z as getClient, n as loadState, _ as isPublicShare, F as cancelableClient, $ as getFavoriteNodes, a0 as join, a1 as validateFilename, a2 as InvalidFilenameError, a3 as InvalidFilenameErrorReason, a4 as sortNodes, a5 as getCurrentUser, a6 as getRecentSearch, a7 as resultToNode, a8 as getDefaultPropfind, a9 as defaultRootPath, aa as mdiFolder, ab as mdiClock, ac as mdiStar, ad as formatFileSize, ae as extname, af as Permission, ag as mdiKey, ah as mdiTagOutline, ai as ShareType, aj as mdiLink, ak as mdiAccountPlus, al as mdiAccountGroupOutline, am as mdiNetworkOutline } from "./vendor-CflEb2sm.chunk.mjs";
import { a9 as watchEffect, t as toValue, x as ref, W as defineComponent, w as watch, o as onMounted, j as openBlock, k as createBlock, Q as withCtx, D as createBaseVNode, p as createElementBlock, I as toDisplayString, u as unref, P as createVNode, d as computed, c as shallowRef, ab as useModel, ac as useTemplateRef, Y as createSlots, F as Fragment, E as renderList, ad as mergeModels, X as onUnmounted, L as createCommentVNode, H as createTextVNode, n as nextTick, G as mergeProps, R as normalizeClass, K as withModifiers, M as toHandlers, v as normalizeStyle, _ as toRef } from "./vue-runtime-R8I1oHZP.chunk.mjs";
...
let FilePicker$2 = class FilePicker {
  title;
  multiSelect;
  mimeTypeFilter;
  directoriesAllowed;
   ...
   */
  async pickNodes() {
    const { default: FilePickerVue } = await __vitePreload(async () => {
      const { default: FilePickerVue2 } = await Promise.resolve().then(() => FilePicker$1);
      return { default: FilePickerVue2 };
...
const FilePicker2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-39182aaf"]]);
const FilePicker$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: FilePicker2
}, Symbol.toStringTag, { value: "Module" }));
export {
  FilePickerClosed as F,
  __vitePreload as _,
  showError as a,
