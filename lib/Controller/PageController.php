...
final class PageController extends Controller {
	...
	public function index(): TemplateResponse {
		...
		$this->initialState->provideInitialState('settings', ['aliasMode' => $this->settings->string('alias_mode'), 'aliasLength' => $this->settings->int('alias_length'), 'allowedSchemes' => $this->settings->allowedSchemes(), 'baseUrl' => $this->settings->validatedBaseUrl(), 'titleFetch' => $this->settings->bool('title_fetch')]);
