...
final class ShortLinkMapper extends QBMapper {
	...
	public function updateWithVersion(ShortLink $link, int $expectedVersion): bool {
		...
		$values = [
			...
			'thumbnail_url' => [$link->getThumbnailUrl(), IQueryBuilder::PARAM_STR], 'thumbnail_path' => [$link->getThumbnailPath(), IQueryBuilder::PARAM_STR],
			'thumbnail_refreshed_at' => [$link->getThumbnailRefreshedAt(), IQueryBuilder::PARAM_INT], 'media_path' => [$link->getMediaPath(), IQueryBuilder::PARAM_STR],
			'media_mime' => [$link->getMediaMime(), IQueryBuilder::PARAM_STR], 'color' => [$link->getColor(), IQueryBuilder::PARAM_STR],
