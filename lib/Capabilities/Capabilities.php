...
final class Capabilities implements ICapability {
	...
	public function getCapabilities(): array {
		...
		return ['shortlinks' => ['version' => '1.0.0', 'apiVersion' => 1, 'enabled' => $this->settings->bool('enabled'), 'features' => $features, 'aliasModes' => ['base36', 'base62', 'random'], 'redirectStatuses' => array_map('intval', $this->settings->array('redirect_statuses', ['301', '302', '307', '308']))]];
	}
}
