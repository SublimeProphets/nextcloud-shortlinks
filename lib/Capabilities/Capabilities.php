...
final class Capabilities implements ICapability {
	...
	public function getCapabilities(): array {
		return ['shortlinks' => ['version' => '1.0.0', 'apiVersion' => 1, 'enabled' => $this->settings->bool('enabled'), 'features' => ['folders', 'tags', 'shares', 'passwords', 'statistics', 'qr', 'import-export', 'bookmarklet'], 'aliasModes' => ['base36', 'base62', 'random'], 'redirectStatuses' => [301, 302, 307, 308]]];
	}
}
