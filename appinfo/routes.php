...
return [
	'routes' => [
		...
		['name' => 'qr#bulk', 'url' => '/qr/bulk', 'verb' => 'GET'],
		['name' => 'qr#show', 'url' => '/qr/{id}', 'verb' => 'GET'],
		['name' => 'thumbnail#preview', 'url' => '/thumbnail/preview', 'verb' => 'GET'],
		['name' => 'link_media#show', 'url' => '/media/{id}/{kind}', 'verb' => 'GET'],
		...
		['name' => 'page_files#show', 'url' => '/p/{slug}/files/{index}', 'verb' => 'GET'],
		['name' => 'public_pages#show', 'url' => '/p/{slug}', 'verb' => 'GET'],
		['name' => 'public_pages#password', 'url' => '/p/{slug}', 'verb' => 'POST'],
	],
	'ocs' => [
		...
		['name' => 'stats_api#exportClicks', 'url' => '/api/v1/links/{id}/clicks/export', 'verb' => 'GET'],
		['name' => 'tools_api#exportLinks', 'url' => '/api/v1/export/links', 'verb' => 'GET'],
		['name' => 'tools_api#exportBackup', 'url' => '/api/v1/export/backup', 'verb' => 'GET'],
		...
		['name' => 'tools_api#metadata', 'url' => '/api/v1/tools/metadata', 'verb' => 'POST'],
		...
		['name' => 'suggestion_api#create', 'url' => '/api/v1/suggestions', 'verb' => 'POST'],
		['name' => 'link_pages_api#index', 'url' => '/api/v1/pages', 'verb' => 'GET'],
		['name' => 'link_pages_api#contacts', 'url' => '/api/v1/pages/contacts', 'verb' => 'GET'],
		['name' => 'link_pages_api#show', 'url' => '/api/v1/pages/{id}', 'verb' => 'GET'],
		['name' => 'link_pages_api#create', 'url' => '/api/v1/pages', 'verb' => 'POST'],
		['name' => 'link_pages_api#update', 'url' => '/api/v1/pages/{id}', 'verb' => 'PATCH'],
		['name' => 'link_pages_api#versions', 'url' => '/api/v1/pages/{id}/versions', 'verb' => 'GET'],
		['name' => 'link_pages_api#version', 'url' => '/api/v1/pages/{id}/versions/{versionNumber}', 'verb' => 'GET'],
		['name' => 'link_pages_api#restoreVersion', 'url' => '/api/v1/pages/{id}/versions/{versionNumber}/restore', 'verb' => 'POST'],
		['name' => 'link_pages_api#destroy', 'url' => '/api/v1/pages/{id}', 'verb' => 'DELETE'],
		['name' => 'link_pages_api#restore', 'url' => '/api/v1/pages/{id}/restore', 'verb' => 'POST'],
