...
Choose **Create bookmarklet** above the app settings in the left navigation to install a draggable browser bookmark. It opens the current page in Shortlinks with its URL prefilled, so a link can be created without copying the address manually.
